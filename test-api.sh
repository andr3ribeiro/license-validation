...
echo "==================================="
echo "US6: Cross-Brand License Lookup Tests"
echo "==================================="
echo ""

echo "Test 6: List all licenses for customer email across all brands"
echo "----------------------------------------------------------------"
echo "Querying licenses for testuser@example.com across RankMath and WP Rocket..."
curl -s "$BASE_URL/api/v1/licenses/by-email?email=testuser@example.com" \
  -H "Authorization: Bearer $RANKMATH_BRAND_API_KEY" | $JQ
echo ""

echo "Note: This demonstrates US6 - brands can query licenses by email across all brands."
echo "The response includes:"
echo "  - All license keys for this email (RankMath and WP Rocket)"
echo "  - Each license key's associated licenses and products"
echo "  - Seat limits and expiration dates"
echo "  - Works with any brand's API key (authenticated brands only)"
echo ""
...
echo ""
echo "User Story US6 - Cross-Brand License Lookup:"
echo "  - GET /api/v1/licenses/by-email?email={email}"
echo "  - Brands can query all licenses for a customer email across all brands"
echo "  - Returns comprehensive information:"
echo "    * All license keys for the email (across RankMath, WP Rocket, etc.)"
echo "    * Each key's associated licenses and products"
echo "    * Brand IDs showing which brands issued each key"
echo "    * Seat limits, expiration dates, and activation status"
echo "  - Security:"
echo "    * Requires Brand API authentication"
echo "    * Only authenticated brands can access this endpoint"
echo "    * End users and external parties cannot access this data"
echo "  - Use cases:"
echo "    * Customer support: view all customer licenses in one query"
echo "    * Account management: see complete customer license portfolio"
echo "    * Cross-brand analytics: understand customer product adoption"
echo ""
